...
namespace WeddingInvites.Security;

/// <summary>
/// Complete copy with some fixes of the baseline identity extensions so we can customise
/// </summary>
public static class CustomIdentityApiEndpointRouteBuilderExtensions
{
    ...
    public static IEndpointConventionBuilder MapCustomIdentityApi<TUser>(this IEndpointRouteBuilder endpoints, bool allowRegistration)
